...
import com.example.asteroidradarapp.utils.Constants
        ...
        if (nearEarthObjectsJson.has(formattedDate)) {
            ...
            for (i in 0 until dateAsteroidJsonArray.length()) {
                ...
                val asteroid = NetworkAsteroid(id, codename, formattedDate, absoluteMagnitude,
                    estimatedDiameter, relativeVelocity, distanceFromEarth, isPotentiallyHazardous, formattedDate)

                Log.d("ASTEROID", asteroid.toString())
